...
export const SHOW_TAGS: Record<string, ShowDefinition> = {
  ...
  "real-housewives-orange-county": {
    tag: "real-housewives-orange-county",
    label: "RHOC",
    fullName: "The Real Housewives of Orange County",
    keywords: ["rhoc", "real housewives of orange county", "vicki gunvalson", "tamra judge", "shannon beador"],
    color: "#F39C12",
  },
  "jersey-shore": {
    tag: "jersey-shore",
    label: "Jersey Shore",
    fullName: "Jersey Shore",
    keywords: ["jersey shore", "snooki", "jwoww", "the situation", "pauly d"],
    color: "#FF6348",
  },
  "the-hills": {
    tag: "the-hills",
    label: "The Hills",
    fullName: "The Hills / Laguna Beach",
    keywords: ["the hills", "laguna beach", "lauren conrad", "kristin cavallari", "spencer pratt"],
    color: "#74B9FF",
  },
  "keeping-up-kardashians": {
    tag: "keeping-up-kardashians",
    label: "Kardashians",
    fullName: "Keeping Up with the Kardashians / The Kardashians",
    keywords: ["kardashians", "kim kardashian", "kris jenner", "keeping up"],
    color: "#FD79A8",
  },
  "flavor-of-love": {
    tag: "flavor-of-love",
    label: "Flavor of Love",
    fullName: "Flavor of Love / I Love New York",
    keywords: ["flavor of love", "i love new york", "tiffany pollard"],
    color: "#E056A0",
  },

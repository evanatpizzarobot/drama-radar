    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div className="flex flex-col gap-10">
        ...
        <section>
          ...
          <p className="mb-4 text-sm leading-relaxed text-dr-text-muted">
            Stay connected with the DramaRadar team on X for breaking news,
            live reactions, and hot takes as they happen.
          </p>
          <a
            href="https://x.com/DramaRadarHQ"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-sm font-semibold text-dr-pink transition-opacity hover:opacity-80"
          >
